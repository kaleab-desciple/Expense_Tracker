...
// Fetch all categories for display or management
$categories_query = $db->query("SELECT * FROM categories WHERE user_id = $user_id");
$categories = array();
                        ...
                        <form action="process_add_category.php" method="POST" class="mbr-form form-with-styler col-lg-6 mx-auto" data-form-title="Form Name">
                            ...
                            <div class="dragArea form-row">
                                <div class="col-sm-12 form-group">
                                    <input type="text" name="category[name]" placeholder="Name" value="<?= $update ? $categoryInfo['name'] : ""; ?>" class="form-control display-7" required="required"/>
                                </div>
